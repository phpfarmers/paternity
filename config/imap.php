...
return [
    ...
    */
    'accounts' => [
        ...
        'qq' => [
            'host' => env('QQ_IMAP_HOST', 'imap.qq.com'),
            'port' => env('QQ_IMAP_PORT', 993),
            'encryption' => env('QQ_IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('QQ_IMAP_VALIDATE_CERT', false),
            'username' => env('QQ_IMAP_USERNAME', 'your_qq_email@qq.com'),
            'password' => env('QQ_IMAP_PASSWORD', 'your_qq_email_password'),
            'protocol' => env('QQ_IMAP_PROTOCOL', 'imap'),
            'auth_mode' => env('QQ_IMAP_AUTHENTICATE', false),
        ],
        /*
